...
// ListModels returns embedded Anthropic model cards.
func ListModels() ([]asmodel.ModelCard, error) {
	return asmodel.LoadModelCardsFSWithDefaults(modelFS, "models", asmodel.NewModelCardDefaults("anthropic", asmodel.ModelCapabilities{
		asmodel.ModelCapabilityTools:      true,
		asmodel.ModelCapabilityEmbedding:  false,
		asmodel.ModelCapabilityGeneration: true,
	}, map[string]any{"api": "messages"}))
}
