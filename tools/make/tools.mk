...
install-tools: install-precommit install-golangcilint install-markdownlint install-codespell install-gitleaks

.PHONY: ci-tools
ci-tools: ## Install tools required by make ci
ci-tools: install-golangcilint install-markdownlint install-codespell install-gitleaks
