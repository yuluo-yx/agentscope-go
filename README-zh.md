...
当前项目重点覆盖文本对话智能体和工具调用工作流，尚未与 Python
AgentScope 完全对齐。未落地的 API 不会在用户文档中宣称可用。
...
| `example/tool/skill` | 将本地 `SKILL.md` 资源加载为智能体工具。 |
| `example/tool/task` | 将任务式工作包装为工具。 |
| `example/workspace/local` | 为 AI 工具工作流提供本地 workspace 文件上下文。 |
